...
const MarketStructureAnalysis = ({ 
  ...
  const calculateRollingCorrelation = (data, window = 20) => {
    const result = [];
  ...
  const correlationData = useMemo(() => {
    ...
    try {
      ...
      if (validData.length < 20) {
        console.log('MarketStructure: Need 20+ data points for correlation, have:', validData.length);
        return [];
      }
        ...
        <div className="space-y-6">
          ...
          {activeSection === 'correlation' && (
            <div className="space-y-6">
              <div className="text-white">
              <div className="bg-gray-800 rounded-lg p-6">
                <h2 className="text-xl font-semibold mb-4">SPY vs VIX Correlation (20-Day Rolling)</h2>
                <ResponsiveContainer width="100%" height={300}>
