...
const SPYDashboard = () => {
  ...
  // Fetch REAL historical data - tries Polygon first, then proxy, then simulated
  const generateHistoricalData = async (currentSpy, currentVix, currentSkew) => {
    try {
      console.log('📈 Fetching historical data from Polygon...');
      
      // Try Polygon first (best option - 100 days of real data)
